...
<svg xmlns="http://www.w3.org/2000/svg" width="390" height="190" viewBox="0 0 390 190" fill="none">
  <style>
    ...
    .user-name { font: 700 28px 'JetBrains Mono', monospace; fill: #0f172a; }
    .stat-label { font: 400 10px 'JetBrains Mono', monospace; fill: #94a3b8; }
    .stat-value { font: 700 18px 'JetBrains Mono', monospace; fill: #0f172a; }
    .top-label { font: 500 12px 'JetBrains Mono', monospace; fill: #64748b; }
    .top-value { font: 700 20px 'JetBrains Mono', monospace; fill: #3b82f6; }
  </style>
  ...
  <g transform="translate(15, 105)">
    <rect x="0" y="0" width="115" height="70" fill="#f8fafc" rx="8" ry="8"/>
  ...
  <!-- 테두리 -->
  <rect x="0.5" y="0.5" width="389" height="189" fill="none" stroke="#e2e8f0" stroke-width="1" rx="12" ry="12"/>
</svg>
  `;
}
